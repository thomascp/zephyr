		 ...
		 int priority, unsigned int options)
{
	...
	stack_init->a0 = (_reg_t)thread_func;
	stack_init->a1 = (_reg_t)arg1;
	stack_init->a2 = (_reg_t)arg2;
	stack_init->a3 = (_reg_t)arg3;
	/*
	...
	stack_init->mepc = (_reg_t)z_thread_entry_wrapper;

#ifndef CONFIG_SMP

	thread->callee_saved.sp = (_reg_t)stack_init;

#else

	stack_sp = (char *)stack_init;
