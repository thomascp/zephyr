...
#define RISCV_REG_SIZE 8
#define ISR_TABLE_SHIFT 4
#define LR ld
#define SR sd 
#else
#define RISCV_REG_SIZE 4
#define ISR_TABLE_SHIFT 3
#define LR lw
#define SR sw
#endif
 ...
 */
static ALWAYS_INLINE unsigned long z_arch_irq_lock(void)
{
	unsigned long key, mstatus;
 ...
 */
static ALWAYS_INLINE void z_arch_irq_unlock(unsigned long key)
{
